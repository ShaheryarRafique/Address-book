...
<body>
    ...
    @include('partials.header', ['headerName' => 'Dashboard']);
    ...
    <div class="container mx-auto lg:px-8 ">
       ...
       <div  class="py-5">
        ...
        {{-- <div class="flex items-center justify-between border-gray-200 mt-5 bg-white py-3 sm:px-6">
            ...
            <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700">
                        ...
                        to
                        <span class="font-medium">{{ $displayContact }}</span>
                        of
                ...
                <div>
                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        <a href="#" aria-current="page"
                            class="relative z-10 inline-flex items-center bg-purple-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600">1</a>
                        <a href="#"
